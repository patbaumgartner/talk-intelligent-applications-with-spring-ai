...
public class AnthropicFunctionCallingApplication {

	public static void main(String[] args) {
		SpringApplication.run(AnthropicFunctionCallingApplication.class, args);
	}
	...
	CommandLineRunner commandLineRunner(ChatClient.Builder chatClientBuilder) {
		...
		return args -> {
			...
			log.info("Anthropic Claude answered: {}", answer);
		};
	}
