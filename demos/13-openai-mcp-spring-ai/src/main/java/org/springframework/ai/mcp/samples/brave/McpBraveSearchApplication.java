...
public class McpBraveSearchApplication {

	public static void main(String[] args) {
		SpringApplication.run(McpBraveSearchApplication.class, args);
	}

	@Bean
	CommandLineRunner predefinedQuestions(ChatClient.Builder chatClientBuilder, List<McpSyncClient> mcpSyncClients) {
		return args -> {
